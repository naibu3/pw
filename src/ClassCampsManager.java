...
public class ClassCampsManager {
    ...
    public void writeMonitors(){
        List<ClassMonitor> listado = loadMonitors(); // Supongamos que tienes una lista de ClassParticipants

        for (ClassMonitor monitor : listado) {
